...
public class JudgeRenderer extends MobRenderer<JudgeEntity, VillagerModel<JudgeEntity>> {
    ...
    public void render(JudgeEntity living, float p_225623_2_, float p_225623_3_, MatrixStack matrixStack, IRenderTypeBuffer buffer, int lightMaybe) {
        ...
        IVertexBuilder ivertexbuilder = buffer.getBuffer(model.getRenderType());
