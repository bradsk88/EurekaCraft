...
public class AeroBookScreen extends AbstractContainerScreen<SandingMachineContainer> {

    private final ResourceLocation GUI = new ResourceLocation(EurekaCraft.MODID, "textures/screens/aero_book_screen.png");

    public AeroBookScreen(SandingMachineContainer container, Inventory playerInv, Component title) {
