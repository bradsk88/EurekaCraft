...
public class ChunkStormCubeForgeRendering {
    ...
    public static void renderLineBox(
        ...
        vertex.endVertex();
        vc.vertex(matrix4f, f, f1, f2).color(r2, g, b2, a).normal(matrix3f, 0.0F, 1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f4, f2).color(r2, g, b2, a).normal(matrix3f, 0.0F, 1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f1, f2).color(r2, g2, b, a).normal(matrix3f, 0.0F, 0.0F, 1.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f1, f5).color(r2, g2, b, a).normal(matrix3f, 0.0F, 0.0F, 1.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f1, f2).color(r, g, b, a).normal(matrix3f, 0.0F, 1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f4, f2).color(r, g, b, a).normal(matrix3f, 0.0F, 1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f4, f2).color(r, g, b, a).normal(matrix3f, -1.0F, 0.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f4, f2).color(r, g, b, a).normal(matrix3f, -1.0F, 0.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f4, f2).color(r, g, b, a).normal(matrix3f, 0.0F, 0.0F, 1.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f4, f5).color(r, g, b, a).normal(matrix3f, 0.0F, 0.0F, 1.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f4, f5).color(r, g, b, a).normal(matrix3f, 0.0F, -1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f1, f5).color(r, g, b, a).normal(matrix3f, 0.0F, -1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f1, f5).color(r, g, b, a).normal(matrix3f, 1.0F, 0.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f1, f5).color(r, g, b, a).normal(matrix3f, 1.0F, 0.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f1, f5).color(r, g, b, a).normal(matrix3f, 0.0F, 0.0F, -1.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f1, f2).color(r, g, b, a).normal(matrix3f, 0.0F, 0.0F, -1.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f, f4, f5).color(r, g, b, a).normal(matrix3f, 1.0F, 0.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f4, f5).color(r, g, b, a).normal(matrix3f, 1.0F, 0.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f1, f5).color(r, g, b, a).normal(matrix3f, 0.0F, 1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f4, f5).color(r, g, b, a).normal(matrix3f, 0.0F, 1.0F, 0.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f4, f2).color(r, g, b, a).normal(matrix3f, 0.0F, 0.0F, 1.0F).uv(0, 0).uv2(0).endVertex();
        vc.vertex(matrix4f, f3, f4, f5).color(r, g, b, a).normal(matrix3f, 0.0F, 0.0F, 1.0F).uv(0, 0).uv2(0).endVertex();
    }
