...
public class SoftChiselItem extends Item implements NoisyCraftingItem, IBoardStatsModifier {
    ...
    private static final Optional<NoisyItem> CRAFTING_SOUND = Optional.of(new NoisyItem(
            16,
    ...
    public void appendHoverText(
        ...
        p_41423_.add(Compat.translatableStyled("item.eurekacraft.soft_chisel.subtitle", GRAY));
    }
