...
public class BlueprintFolderItem extends Item implements MenuProvider {
    ...
    public void appendHoverText(
        ...
        int size = nbt.contains(STACK_ITEMS_NBT) && nbt.getCompound(STACK_ITEMS_NBT)
                                                       .contains("Items") ? nbt.getCompound(STACK_ITEMS_NBT)
                                                                               .getList("Items", Tag.TAG_COMPOUND)
                                                                               .size() : 0;

        tooltip.add(Compat.translatableStyled("item." + EurekaCraft.MODID + "." + ITEM_ID + ".subtitle", GRAY));
        tooltip.add(
                // TODO: Translate
                Compat.literal("Contains " + size + " blueprints"));
    }

    @Override
    public Component getDisplayName() {
        return Compat.translatable("container." + EurekaCraft.MODID + ".folder");
    }
    ...
    public AbstractContainerMenu createMenu(
        ...
        return new FolderContainer(windowId, p_39955_, null);
    }
    ...
    private static class ItemHandler extends ItemStackHandler {
        ...
        protected void onContentsChanged(int slot) {
            this.host.getOrCreateTag().put(STACK_ITEMS_NBT, this.serializeNBT());
        }
        ...
        public boolean isItemValid(
            ...
            return Ingredient.of(TagsInit.Items.BLUEPRINTS).test(stack);
        }
    }
}
