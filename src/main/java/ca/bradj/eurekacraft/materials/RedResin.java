...
public class RedResin extends Item {
    ...
    public void appendHoverText(
        ...
        p_41423_.add(Compat.translatableStyled("item.eurekacraft.resins.subtitle", GRAY));
        p_41423_.add(Compat.translatableStyled("item.eurekacraft.red_resins.subtitle", GRAY));
    }
}
