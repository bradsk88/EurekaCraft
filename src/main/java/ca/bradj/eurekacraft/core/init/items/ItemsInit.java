...
public class ItemsInit {
    ...
    public static final RegistryObject<Item> FRESH_SEEDS_ITEM = ITEMS.register(FreshSeeds.ITEM_ID, FreshSeeds::new);

    public static final RegistryObject<Item> FRESH_LEAVES_ITEM = ITEMS.register(
            FreshSmellingLeaves.ITEM_ID,
            FreshSmellingLeaves::new
    );
...
//	);
    ...
    public static final RegistryObject<Item> RESIN_BLOCK = ITEMS.register(
            ResinBlock.ITEM_ID, () -> new BlockItem(BlocksInit.RESIN.get(), ResinBlock.ITEM_PROPS) {
                @Override
                public void appendHoverText(
                    ...
                    p_40574_.add(Compat.translatableStyled("item.eurekacraft.resins.subtitle", GRAY));
                }
            }
    );
    public static final RegistryObject<Item> RED_RESIN_BLOCK = ITEMS.register(
            RedResinBlock.ITEM_ID, () -> new BlockItem(BlocksInit.RED_RESIN.get(), RedResinBlock.ITEM_PROPS) {
                @Override
                public void appendHoverText(
                        ItemStack p_40572_,
                        @Nullable Level p_40573_,
                    ...
                    p_40574_.add(Compat.translatableStyled("item.eurekacraft.resins.subtitle", GRAY));
                    p_40574_.add(Compat.translatableStyled("item.eurekacraft.red_resins.subtitle", GRAY));
                }
            }
    );
