...
public class TilesInit {
    ...
    public static final RegistryObject<TileEntityType<SandingMachineTileEntity>> SANDING_MACHINE = TILES.register(
            SandingMachineTileEntity.ENTITY_ID, () -> TileEntityType.Builder.of(
