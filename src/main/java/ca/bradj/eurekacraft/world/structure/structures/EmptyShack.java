...
public class EmptyShack extends Structure<NoFeatureConfig> {
    public EmptyShack() {
    ...
    public static class Start extends StructureStart<NoFeatureConfig> {
        ...
        public void generatePieces(DynamicRegistries drMan, ChunkGenerator chunkGen, TemplateManager templateMan, int chunkX, int chunkZ, Biome p_230364_6_, NoFeatureConfig p_230364_7_) {
            ...
            Supplier<JigsawPattern> supplier = () -> drMan.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY).get(new ResourceLocation(EurekaCraft.MODID, "empty_shack/start_pool"));
